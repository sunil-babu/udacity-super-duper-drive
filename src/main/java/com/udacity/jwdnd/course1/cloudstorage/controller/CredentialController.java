...
public class CredentialController {
    ...
    public String newCredential(
            ...
            @ModelAttribute("newNote") NoteForm newNote, Model model) {
        String userName = authentication.getName();
        String newUrl = credentialForm.getUrl();
        ...
        if (credentialIdStr.isEmpty()) {
            credentialService.addCredential(newUrl, userName, credentialForm.getUserName(), encodedKey, encryptedPassword);
        } else {
            Credential existingCredential = getCredential(Integer.parseInt(credentialIdStr));
            credentialService.updateCredential(existingCredential.getCredentialid(), credentialForm.getUserName(), newUrl, encodedKey, encryptedPassword);
        }
        User user = userService.getUser(userName);
